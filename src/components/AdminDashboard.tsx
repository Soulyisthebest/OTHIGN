        ...
        <div className="space-y-6">
          <div>
            ...
            <h2 className="text-xl font-black text-white mt-1 select-none flex items-center gap-2">
              BI Dashboard
              <span className="text-[10px] bg-red-500/20 text-red-400 px-1.5 py-0.5 rounded font-mono border border-red-500/30">Owner</span>
            </h2>
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            {editingMetrics && (
              <div className="p-4 bg-[#10192e] border border-amber-500/30 rounded-2xl space-y-4">
                <h4 className="text-xs font-bold uppercase tracking-widest text-amber-400">Modificación de Parámetros de Negocio (Satisfacción del Dueño)</h4>
                  ...
                  <div className="flex justify-around items-center pt-2">
                    <div className="text-center">
                      ...
                      <strong className="text-sm font-mono text-white">
                        {genderCounts["Femenino"] || 0} ({(((genderCounts["Femenino"] || 0)/totalStudents)*100).toFixed(0)}%)
                      </strong>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <strong className="text-sm font-mono text-white">
                        {genderCounts["Masculino"] || 0} ({(((genderCounts["Masculino"] || 0)/totalStudents)*100).toFixed(0)}%)
                      </strong>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-[#0e162a] border border-[#1c2e4f] p-5 rounded-3xl space-y-3.5">
                ...
                <p className="text-3xl font-black text-white">
                  {students.filter(s => s.hasCv).length} <span className="text-xs text-gray-500">alumnos ({((students.filter(s => s.hasCv).length / totalStudents) * 100).toFixed(0)}%)</span>
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-[#0e162a] border border-[#1c2e4f] p-5 rounded-3xl space-y-4">
                <h4 className="text-xs font-bold uppercase tracking-wider text-amber-400 flex items-center gap-2">
                  <Plus size={14} />
                  <span>Configurar Alerta Manual (Dueño)</span>
                </h4>
                ...
                <div className="bg-[#0b1224] border border-[#1c2e4f] p-5 sm:p-6 rounded-3xl space-y-4 shadow-xl">
                  ...
                  <form onSubmit={handleSaveTeacher} className="space-y-3.5 text-xs">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="text-[10px] text-gray-400 uppercase font-mono block mb-1">Teléfono / WhatsApp:</label>
                        <input 
                          type="tel"
